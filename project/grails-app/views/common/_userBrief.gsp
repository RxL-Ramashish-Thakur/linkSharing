<div class="row g-0 bd">
    <div class="col-md-4 container mt-1">
        <g:if test="${user?.photo}">
            <img src="${createLink(controller: 'user', action: 'showImage', id: user?.id)}"
        ...
        <div class="m-1 text-secondary">
            ...
            <div class="d-flex gap-5">
                <div>
                    ...
                    <g:link controller="topic" action="subscribeTopic">${subscriptionCount}</g:link>
                </div>

                <div>
                    <div>topics</div>
                    <g:link  controller="topic"  action="myTopics" >${topicCount}</g:link>
                </div>
            </div>
        </div>
    </div>
